        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row -mx-4">
            ...
            <div className="md:flex-1 px-4">
              ...
              <div className="my-4 text-4xl text-gray-700 ">${crop.price}</div>
              ...
              <div className="mt-2 text-sm text-gray-500">
                {crop.available ? `${crop.quantity} in stock` : "Out of stock"}
              </div>
			  ...
			  <div className="mt-7">
				<button className="bg-[#363636] text-white py-3 w-full flex items-center gap-3 justify-center"><svg xmlns="http://www.w3.org/2000/svg" fill="none" height="30" viewBox="0 0 16 16" width="30"><g fill="currentColor"><path d="m2.5 2c-.27614 0-.5.22386-.5.5s.22386.5.5.5h.2457c.22324 0 .41943.14799.48076.36264l1.58556 5.54944c.18398.64395.77256 1.08792 1.44228 1.08792h4.5687c.6133 0 1.1649-.37343 1.3927-.94291l1.4743-3.6857c.2627-.65686-.2211-1.37139-.9285-1.37139h-8.31292l-.2606-.91208c-.18398-.64395-.77256-1.08792-1.44228-1.08792z"/><path d="m6.5 14c.82843 0 1.5-.6716 1.5-1.5s-.67157-1.5-1.5-1.5-1.5.6716-1.5 1.5.67157 1.5 1.5 1.5z"/><path d="m10.5 14c.8284 0 1.5-.6716 1.5-1.5s-.6716-1.5-1.5-1.5c-.82843 0-1.5.6716-1.5 1.5s.67157 1.5 1.5 1.5z"/></g></svg> Add to cart</button>
			  </div>
