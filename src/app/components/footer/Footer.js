      ...
      <div className="mt-20">
        ...
        <div className="py-10 flex-col   md:flex md:flex-row  w-[90%] mx-auto gap-[10%]">
          ...
          <div className="max-w-sm ">
            ...
            <p>Our mission is to provide you with the freshest and most sustainable produce possible</p>
          </div>
        ...
        <p className="text-center mb-3">Copyright @producers pantry. All Right Reserved</p>
      </div>
    </>
  );
};
